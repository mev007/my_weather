  ...
  Widget _buildListRow(List<UserListWeather> weatherList) {
    return Container(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          final icon = (controller.codeError.value == 888 || index == 0)
              ? null
              ...
              : Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Expanded(child: Utils.getIconImage(icon), flex: 2),
                      Expanded(
                      ...
                      Expanded(
                        ...
                        style: TextStyle(
                            fontWeight: FontWeight.bold,
                            color:
                                ((weatherList[index - 1].temp?.round() ?? 0) <
                                        0)
                                    ? Colors.blueAccent[700]
                                    : Colors.redAccent[700]),
                      )),
                      Expanded(
                          child: Text('${weatherList[index - 1].humidity}')),
                      Expanded(
                          child:
